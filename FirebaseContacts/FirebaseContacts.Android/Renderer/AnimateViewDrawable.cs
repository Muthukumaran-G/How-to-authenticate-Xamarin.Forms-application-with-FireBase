...
namespace FirebaseContacts.Droid.Renderer
{
    ...
    {
        readonly CustomAnimatedView _pancake;
        ...
        public PancakeDrawable(CustomAnimatedView pancake, Func<double, float> convertToPixels)
        {
            _pancake = pancake;
            _convertToPixels = convertToPixels;
            _pancake.PropertyChanged += CustomAnimatedViewOnPropertyChanged;
        }
        ...
        void CustomAnimatedViewOnPropertyChanged(object sender, PropertyChangedEventArgs e)
        {
            if (e.PropertyName == VisualElement.BackgroundColorProperty.PropertyName ||
                e.PropertyName == CustomAnimatedView.CornerRadiusProperty.PropertyName ||
                e.PropertyName == CustomAnimatedView.BackgroundGradientAngleProperty.PropertyName ||
                e.PropertyName == CustomAnimatedView.BackgroundGradientStartColorProperty.PropertyName ||
                e.PropertyName == CustomAnimatedView.BackgroundGradientEndColorProperty.PropertyName ||
                e.PropertyName == CustomAnimatedView.BackgroundGradientStopsProperty.PropertyName ||
                e.PropertyName == CustomAnimatedView.SidesProperty.PropertyName ||
